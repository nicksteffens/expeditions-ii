...
function ThreeSixtyPlayer() {
  ...
  this.config = {
    ...
    loadRingColor: '#dedede', // how much has loaded
    playRingColor: '#c92100', // how much has played
    backgroundRingColor: '#dedede', // color shown underneath load + play ("not yet loaded" color)
